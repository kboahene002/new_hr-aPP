            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <form id="kt_modal_new_target_form " class="form" action="#">
                    ...
                    <div class="mb-13 text-center">
                        <h1 class="mb-3">Add a new promotion level</h1>
                    </div>
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                            <span class="required">Promotion</span>
                        </label>

                        <input type="text"
                            value="@if (isset($find)) {{ $find->promotion_name }} @endif"
                            class="form-control form-control" placeholder="Enter a new promotion  "
                            name="promotion_name" />
                    </div>
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Setup - Promotion Type List</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    <a href="#" id="modal_popup" class="btn  btn-sm fw-bold btn-primary" data-bs-toggle="modal"
                        data-bs-target="#kt_modal_new_target">Add New Promotion Type</a>
                </div>
                <!--end::Actions-->
            </div>
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">List Of Promotion Type</span>
                                <span class="text-muted mt-1 fw-semibold fs-7">({{ count($promotion) }})
                                    Promotion type
                                    found</span>
                            </h3>
                            ...
                            <div style=" " class="d-flex justify-content-between mb-4">
                                ...
                                <div class="form-outline me-3" style="width: 18rem">
                                    <input required type="text" name="keyword"
                                        placeholder="Search Promotion type list" id="fff"
                                        class="form-control " />
                            ...
                            <div class="table-responsive">
                                ...
                                <table id="department" class="table table-row-dashed align-middle gs-0 gy-4">
                                    ...
                                    <tbody>
                                                ...
                                                <td class="ps-4">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <a href="#"
                                                                class="text-dark fw-bold text-hover-primary mb-1 fs-6">{{ Str::ucfirst($item->promotion_name) }}</a>
                                                        </div>
                                                    </div>
                                                </td>
                                        ...
                                        @empty
                                            <small>Promotion list is currently empty</small>
                                        @endforelse
