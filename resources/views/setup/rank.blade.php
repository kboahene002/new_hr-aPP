            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <form id="kt_modal_new_target_form " class="form" action="#">
                    ...
                    <div class="mb-13 text-center">
                        <h1 class="mb-3">Add a new Rank or Permission</h1>
                    </div>
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                            <span class="required">Position or rank</span>
                        </label>

                        <input type="text"
                            value="@if (isset($find)) {{ $find->position_name }} @endif"
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-12 fv-row">
                            <label class="required fs-6 fw-semibold mb-2">Department (Division)</label>
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <input value="@isset($find) {{ $find->rank_description }} @endisset"
                            type="text" class="form-control " placeholder="Enter a description" name="rank_description" />
                    </div>
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Setup - Rank / Position  List</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    <a href="#" id="modal_popup" class="btn  btn-sm fw-bold btn-primary" data-bs-toggle="modal"
                        data-bs-target="#kt_modal_new_target">Add New Rank List</a>
                </div>
                <!--end::Actions-->
            </div>
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">Rank / Position List</span>
                                <span class="text-muted mt-1 fw-semibold fs-7">({{ count($rank) }})
                                    Rank / Position list
                                    found</span>
                            </h3>
                            ...
                            <div style=" " class="d-flex justify-content-between mb-4">
                                ...
                                <div class="form-outline me-3" style="width: 18rem">
                                    <input required type="text" name="keyword"
                                        placeholder="Search  Rank/Position list" c
                                        class="form-control " />
                            ...
                            <div class="table-responsive">
                                ...
                                <table id="department" class="table table-row-dashed align-middle gs-0 gy-4">
                                    ...
                                    @if (count($rank) > 0)
                                        <thead>
                                            <tr class="fw-bold text-muted bg-light">
                                                <th class="ps-4">Ranks / Position</th>
                                                <th>Department (Division)</th>
                                                <th>Rank Position Description</th>
                                                <th>Action</th>
                                            </tr>
                                        </thead>
                                    @endif
                                    ...
                                    <tbody>
                                                ...
                                                <td class="ps-4">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <a href="#"
                                                                class="text-dark fw-bold text-hover-primary mb-1 fs-6">{{ Str::ucfirst($item->position_name) }}</a>
                                                        </div>
                                                    </div>
                                                </td>
                                        ...
                                        @empty
                                            <small>Rank list is currently empty</small>
                                        @endforelse
