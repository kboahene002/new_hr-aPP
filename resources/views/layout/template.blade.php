...
<html lang="en">
	...
	<body id="kt_app_body" data-kt-app-layout="dark-sidebar"
								...
								<div class="app-navbar-item ms-1 ms-md-3"
									...
									<div
											...
											<div class="menu-content d-flex align-items-center px-3">
												...
												<div class="d-flex flex-column">
													<div class="fw-bold d-flex align-items-center fs-5">{{Auth::user()->name}}
														<span
															class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Admin</span></div>
										...
										<div class="menu-item px-5">
											<a 
												href="#"
												class="logout menu-link px-5">Sign Out
											</a>
										</div>
										<!--end::Menu item-->
									</div>
								...
								<div class="menu menu-column menu-rounded menu-sub-indention px-3"
									...
									<div data-kt-menu-trigger="click"
										...
										<div class="menu-item pt-5">
											...
											<div class="menu-content">
												<span class="menu-heading fw-bold text-uppercase fs-7">Setup</span>
											</div>
											<!--end:Menu content-->
										</div>
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
										...
										<div class="menu-sub menu-sub-accordion">
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link" onclick="loadPage('departmentList' , event  , $(this))" href="#">
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link" onclick="loadPage('jobCategory' , event , $(this))" class="menu-link"
													href="#">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link" onclick="loadPage('maritalStatus' , event , $(this))" class="menu-link"
													href="#">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link" onclick="loadPage('staffStatus' , event , $(this))" class="menu-link"
													href="#">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
													<span class="menu-title">Staff Status</span>
												</a>
												<!--end:Menu link-->
											</div>
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link" onclick="loadPage('dependantType' , event , $(this))" class="menu-link"
													href="#">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
													<span class="menu-title">Dependent Type</span>
												</a>
												<!--end:Menu link-->
											</div>
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a onclick="loadPage('qualificationType' , event , $(this))" class="menu-link"
													href="#">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
													<span class="menu-title">Qualification Type</span>
												</a>
												<!--end:Menu link-->
											</div>
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a onclick="loadPage('promotion' , event , $(this))" class="menu-link"
													href="#">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a onclick="loadPage('appraisalType' , event , $(this))" class="menu-link"
													href="#">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
													<span class="menu-title">Appraisal Type</span>
												</a>
												<!--end:Menu link-->
											</div>
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a onclick="loadPage('leaveType' , event , $(this))" class="menu-link"
													href="#">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a onclick="loadPage('disciplinaryType' , event , $(this))" class="menu-link"
													href="#">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
													<span class="menu-title">Disciplinary Type</span>
												</a>
												<!--end:Menu link-->
											</div>
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a onclick="loadPage('salaryGradeNotch' , event , $(this))" class="menu-link"
													href="#">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
													<span class="menu-title">Salary Grade / Notch List</span>
												</a>
												<!--end:Menu link-->
											</div>
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a onclick="loadPage('jobList' , event , $(this))" class="menu-link"
													href="#">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a onclick="loadPage('ranks' , event , $(this))" class="menu-link"
													href="#">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
													<span class="menu-title">List of Ranks/Positions</span>
												</a>
												<!--end:Menu link-->
											</div>
									...
									<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
										...
										<div class="menu-sub menu-sub-accordion">
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a onclick="loadPage('employee' , event  , $(this))" class="menu-link"
													href="#">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
			...
			<div class="card shadow-none border-0 rounded-0">
				...
				<div class="card-body position-relative" id="kt_activities_body">
					...
					<div id="kt_activities_scroll"
						class="position-relative scroll-y me-n5 pe-5" data-kt-scroll="true"
								...
								<div class="timeline-content mb-10 mt-n1">
									...
									<div class="pe-3 mb-5">
										...
										<div class="fs-5 fw-semibold mb-2">New case
											...
											to you in Multi-platform Database Design project</div>
										<!--end::Title-->
										<!--begin::Description-->
										<div class="overflow-auto pb-5">
											<!--begin::Wrapper-->
		...
		<div id="kt_drawer_chat" class="bg-body" data-kt-drawer="true"
			data-kt-drawer-name="chat" data-kt-drawer-activate="true"
			data-kt-drawer-overlay="true"
						...
						<div class="d-flex justify-content-end mb-10">
							...
							<div class="d-flex flex-column align-items-end">
								...
								<div
									...
									know that you’ve been subscribed to a repository on GitHub.</div>
								<!--end::Text-->
							</div>
							<!--end::Wrapper-->
						</div>
					...
					<div class="d-flex flex-stack">
						...
						<div class="d-flex flex-column me-3">
							...
							<div class="mb-3">
								...
								<span class="text-gray-400 fw-semibold d-block">The best kitchen gadget
									in 2022</span>
							</div>
							<!--end::Section-->
							<!--begin::Section-->
					...
					<div class="d-flex flex-stack">
						...
						<div class="d-flex flex-column me-3">
							...
							<div class="mb-3">
								...
								<span class="text-gray-400 fw-semibold d-block">Professional camera for
									edge</span>
							</div>
							<!--end::Section-->
							<!--begin::Section-->
